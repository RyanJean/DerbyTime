<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RaceRun.aspx.cs" Inherits="DerbyTimeWeb.RaceRun" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width: <%=(DerbyTimeWeb.MySession.Current.num_Lanes*150)+400 %>px; margin: 10px auto; text-align: center;">
        <div style="float: left"><asp:PlaceHolder ID="errZone" runat="server"></asp:PlaceHolder><asp:PlaceHolder ID="leftZone" runat="server"></asp:PlaceHolder></div>
